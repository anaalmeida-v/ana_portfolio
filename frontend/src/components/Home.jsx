...
const contacts = [
  {
    label: 'Email',
    value: 'anacarolinavenancio@gmail.com',
    href: 'mailto:anacarolinavenancio@gmail.com',
    icon: (
  ...
  {
    label: 'LinkedIn',
    value: 'linkedin.com/in/ana-carolina',
    href: 'https://linkedin.com/in/ana-carolina',
    icon: (
  ...
  {
    label: 'GitHub',
    value: 'github.com/anacarolina',
    href: 'https://github.com/anacarolina',
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
